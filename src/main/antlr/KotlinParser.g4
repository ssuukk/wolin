...
typeParameter
    : modifierList? NL* simpleIdentifier (NL* COLON NL* type NL* )?
    ;
...
typeReference
    ...
    | userType (arrayDeclaration)? (NL* CARON locationReference)?
    | DYNAMIC
    ;

arrayDeclaration
    : LSQUARE (userType)? RSQUARE
    ;
