...
alloc SP<__wolin_reg1>[ubyte], #1 // for declaration vali=0
alloc SP<__wolin_reg2>[ubyte], #1 // for var pl.qus.wolin.print..i init expression
...
free SP<__wolin_reg2>[ubyte], #1 // for var pl.qus.wolin.print..i init expression
// top type already set: __wolin_reg1: ubyte = 0 /* for declaration vali=0 */
free SP<__wolin_reg1>[ubyte], #1 // for declaration vali=0
alloc SP<__wolin_reg3>[ubyte*], #2 // for declaration varchar:ubyte=what[i]
alloc SP<__wolin_reg4>[ubyte*], #2 // for var pl.qus.wolin.print..char init expression
alloc SP<__wolin_reg5>[ubyte*], #2 // arr_deref
//  LEWA strona array access, czyli co to za zmienna
alloc SP<__wolin_reg6>[ubyte*], #2 // array variable
...
alloc SP<__wolin_reg7>[uword], #2 // For calculating index
...
free SP<__wolin_reg5>[ubyte*], #2 // arr_deref
...
free SP<__wolin_reg4>[ubyte*], #2 // for var pl.qus.wolin.print..char init expression
// top type already set: __wolin_reg3: ubyte* = 0 /* for declaration varchar:ubyte=what[i] */
free SP<__wolin_reg3>[ubyte*], #2 // for declaration varchar:ubyte=what[i]
alloc SP<__wolin_reg9>[bool], #1 // for while condition
_scope_ loop,1
label __wolin_lab_loop_start_1
alloc SP<__wolin_reg10>[ubyte], #1 // LEFT equality check: evalneq
...
alloc SP<__wolin_reg11>[ubyte], #1 // RIGHT equality check: evalneq
// switchType to:ubyte by parse literal constant
let SP(0)<__wolin_reg11>[ubyte] = #0[ubyte] // atomic ex
// top type already set: __wolin_reg11: ubyte = 0 /* RIGHT equality check: evalneq */
evalneq SP(2)<__wolin_reg9>[bool] = SP(1)<__wolin_reg10>[ubyte], SP(0)<__wolin_reg11>[ubyte] // two sides
free SP<__wolin_reg11>[ubyte], #1 // RIGHT equality check: evalneq
free SP<__wolin_reg10>[ubyte], #1 // LEFT equality check: evalneq
...
alloc SP<__wolin_reg14>[ubyte], #1 // for call argument 0
// Prze visit vALUE
...
free SP<__wolin_reg14>[ubyte], #1 // for call argument 0, type = ubyte
...
alloc SP<__wolin_reg15>[ubyte*], #2 // for blockLevel expression
...
free SP<__wolin_reg15>[ubyte*], #2 // for blockLevel expression
// 
// == ASSIGNMENT PUSH =======================================
// 
// == ASSIGNMENT LEFT =======================================
alloc SP<__wolin_reg17>[ubyte], #1 // ASSIGNMENT target
...
// switchType to:ubyte by type from pl.qus.wolin.print..char
// == ASSIGNMENT RIGHT =======================================
alloc SP<__wolin_reg18>[ubyte*], #2 // ASSIGNMENT value
// (do assignRightSideFinalVar 1 przypisano __wolin_reg18: ubyte* = 0 /* ASSIGNMENT value */)
alloc SP<__wolin_reg19>[ubyte*], #2 // arr_deref
//  LEWA strona array access, czyli co to za zmienna
alloc SP<__wolin_reg20>[ubyte*], #2 // array variable
let SP(0)<__wolin_reg20>[ubyte*] = SPF(2)<pl.qus.wolin.print.what>[ubyte*] // przez sprawdzacz typow - simple id from var
// switchType to:ubyte* by type from pl.qus.wolin.print.what
//  PRAWA strona array access, czyli indeks w nawiasach
alloc SP<__wolin_reg21>[uword], #2 // For calculating index
...
free SP<__wolin_reg9>[bool], #1 // for while condition
...
alloc SP<__wolin_reg24>[ubyte*], #2 // for call argument 0
// Prze visit vALUE
...
free SP<__wolin_reg24>[ubyte*], #2 // for call argument 0, type = ubyte*
// switchType to:unit by function return type 2
// switchType to:unit by function call
