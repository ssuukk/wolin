...
; 14: evalneq SP(0)<__wolin_reg9>[bool] = SPF(0)<pl.qus.wolin.print..char>[ubyte] , #0[ubyte] 
...
; 23: goto __wolin_lab_loop_start_1[uword] 

    jmp __wolin_lab_loop_start_1

; 25: label __wolin_lab_loop_end_1 

__wolin_lab_loop_end_1:

; 26: free SP<__wolin_reg9> , #1 

    inx

; 27: free SPF<__wolin_pl_qus_wolin_print> , #4 
...
; 29: function __wolin_pl_qus_wolin_main 

__wolin_pl_qus_wolin_main:

; 30: alloc SPF<__wolin_pl_qus_wolin_print> , #4 
...
; 31: let SPF(2)<pl.qus.wolin.print.what>[ubyte*] = #__wolin_lab_stringConst_0[uword] 
...
; 32: call __wolin_pl_qus_wolin_print[uword] 
...
; 34: string __wolin_lab_stringConst_0[uword] = $"dupa" 
