...
public interface KotlinParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link KotlinParser#arrayDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArrayDeclaration(KotlinParser.ArrayDeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link KotlinParser#locationReference}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLocationReference(KotlinParser.LocationReferenceContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asmblock}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsmblock(KotlinParser.AsmblockContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asmprog}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsmprog(KotlinParser.AsmprogContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asmline}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsmline(KotlinParser.AsmlineContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asminstruction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsminstruction(KotlinParser.AsminstructionContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asmlbl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsmlbl(KotlinParser.AsmlblContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asmargumentlist}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsmargumentlist(KotlinParser.AsmargumentlistContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asmlabel}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsmlabel(KotlinParser.AsmlabelContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asmargument}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsmargument(KotlinParser.AsmargumentContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asmprefix}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsmprefix(KotlinParser.AsmprefixContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asmstring}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsmstring(KotlinParser.AsmstringContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asmname}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsmname(KotlinParser.AsmnameContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asmnumber}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsmnumber(KotlinParser.AsmnumberContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asmcomment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsmcomment(KotlinParser.AsmcommentContext ctx);
	/**
	 * Visit a parse tree produced by {@link KotlinParser#asmopcode}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAsmopcode(KotlinParser.AsmopcodeContext ctx);
}