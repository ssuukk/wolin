...
// == ASSIGNMENT RIGHT =======================================
alloc SP<__wolin_reg8>, #1 // ASSIGNMENT value
...
// po visit value
let SPF(1)[ubyte] = SP(0)<__wolin_reg9>[ubyte]
free SP<__wolin_reg9>, #1 // for call argument 0, type = ubyte
// == FN_CALL: ARG #1 (2) pl.qus.wolin.suma
alloc SP<__wolin_reg10>, #1 // for call argument 1
// Prze visit vALUE
//  obliczenia dla parametru 2
// switchType to:ubyte by parse literal constant
let SP(0)<__wolin_reg10>[ubyte] = #2[ubyte] // atomic ex
// po visit value
let SPF(0)[ubyte] = SP(0)<__wolin_reg10>[ubyte]
free SP<__wolin_reg10>, #1 // for call argument 1, type = ubyte
// switchType to:ubyte by function type 2
// switchType to:ubyte by function call
call __wolin_pl_qus_wolin_suma[adr]

let SP(0)<__wolin_reg8>[ubyte] = SPF(0)<returnValue>[ubyte] // przez sprawdzacz typow - copy return parameter
free SPF <ubyte>, #1
// == FN_CALL END: pl.qus.wolin.suma ========
// 
let &SP(1)<__wolin_reg7>[ubyte*] = SP(0)<__wolin_reg8>[ubyte] // przez sprawdzacz typow - process assignment
free SP<__wolin_reg8>, #1 // ASSIGNMENT value, type = ubyte
free SP<__wolin_reg7>, #2 // ASSIGNMENT target
// == ASSIGNMENT END =======================================
// 
// switchType to:unit by assignment
// top type already set: __wolin_reg6: unit = 65535 (for expression)
// caller ma obowiązek zwolnoć wartość zwrotną z SPF!!!
// return from function body
ret
