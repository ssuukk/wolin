...
Inside_INTERRUPT: INTERRUPT -> type(INTERRUPT) ;
Inside_CC65: CC65 -> type(CC65) ;
...
StrExpr_CARON: CARON  -> type(CARON) ;
...
Inside_BIT_AND: BIT_AND  -> type(BIT_AND) ;
StrExpr_BIT_AND: BIT_AND  -> type(BIT_AND) ;

Inside_BIT_OR_ASSIGNMENT: BIT_OR_ASSIGNMENT  -> type(BIT_OR_ASSIGNMENT) ;
StrExpr_BIT_OR_ASSIGNMENT: BIT_OR_ASSIGNMENT  -> type(BIT_OR_ASSIGNMENT) ;

Inside_BIT_AND_ASSIGNMENT: BIT_AND_ASSIGNMENT  -> type(BIT_AND_ASSIGNMENT) ;
StrExpr_BIT_AND_ASSIGNMENT: BIT_AND_ASSIGNMENT  -> type(BIT_AND_ASSIGNMENT) ;
